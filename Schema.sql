...
DROP TABLE IF EXISTS um_notif;
CREATE TABLE um_notif (
	ID_REGISTRO INT,
	ENTIDAD_UM_NOTIF INT,
    MUNICIPIO_UM_NOTIF INT,
    INSTITUCION_UM_NOTIF INT
...
DROP TABLE IF EXISTS lugar_asignacion;
CREATE TABLE lugar_asignacion (
	ID_REGISTRO INT,
	ENTIDAD_ASIG INT,
	MUNICIPIO_ASIG INT
);
...
SELECT ID_REGISTRO, SEXO, EDAD_ANOS, HABLA_LENGUA_INDIG, INDIGENA, FECHA_SIGN_SINTOMAS, TIPO_PACIENTE, DEFUNCION, DICTAMEN, TOMA_MUESTRA, RESULTADO_PCR, ESTATUS_CASO
FROM dengue;
...
INSERT INTO lugar_residencia
SELECT ID_REGISTRO,	ENTIDAD_RES, MUNICIPIO_RES
FROM dengue;

INSERT INTO lugar_asignacion
SELECT ID_REGISTRO,	ENTIDAD_ASIG, MUNICIPIO_ASIG
FROM dengue;

INSERT INTO um_notif
SELECT ID_REGISTRO,	ENTIDAD_UM_NOTIF, MUNICIPIO_UM_NOTIF, INSTITUCION_UM_NOTIF
FROM dengue;